...
> [!TIP]
> If you are setting up LBS on a new machine for the first time, check out our step-by-step [Kickstart Guide](file:///d:/sources/sly/local-builds-scheduler/docs/kickstart.md) for detailed environment and config guidance.
